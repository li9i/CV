...
09.2005 $-$ 07.2013 & \textbf{Δίπλωμα Ηλεκτρολόγου Μηχανικού \& Μηχανικού Υπολογιστών} \\
                    ...
                    & Βαθμός: 7.94 / 10.0, Κατάταξη: 23 / 280 $-$ 92$^{ρο}$ εκατοστημόριο \\
\end{tabular}\\
...
$09.2016 - 11.2016$ & \textbf{Βοηθός Διδασκαλίας} για το μάθημα DD2380 $-$ Artificial Intelligence, KTH, Στοκχόλμη, Σουηδία\\
&\\
%------------------------------------------------
...
&\\
Εργαλεία & UML, Git, OpenCV, \LaTeX, Apache HTTP Server,\\
