...
$09.2015 - 06.2017$ & \textbf{Master of Science} $-$ Kungliga Tekniska H$\ddot{o}$gskolan (KTH), Stockholm, Sweden\\
...
&\\
$09.1999 - 06.2005$ & \textbf{Secondary education diploma} $-$ Anatolia High School, Thessaloniki \\
                    & GPA: $19.0 / 20.0$ \\
\end{tabular}\\
...
\begin{tabular}{rp{12cm}}
Languages & C/C++, MATLAB, SQL, Java, Python, Shell Scripting, Assembly \\
&\\
Operating / Meta-operating Systems & Linux, ROS \\
&\\
Graphics Applications & AutoCAD, Gimp\\
&\\
Tools & UML, Git, OpenCV, \LaTeX, Apache HTTP Server,\\
  & Oracle Forms / Reports, AVR studio, OpenOffice, PSpice \\
